        ...
        <Container sx={{ my: 3 }}>
            ...
            <Stack spacing={5} mt={5}>
                ...
                <Stack spacing={1} sx={{px: 4, py: 1, borderRadius: 5}}>
                    ...
                    <Typography variant="body1">3. データセットの詳細な内容については、詳細説明をご確認ください。</Typography>
                </Stack>
                <Stack spacing={1} bgcolor="#FFCF5F" sx={{padding: 4, borderRadius: 5}}>
                    ...
                    <Typography variant="body1">本データセットには、アンチウィルスソフトによって悪性判定されるファイルが含まれている可能性があります。</Typography>
                </Stack>
